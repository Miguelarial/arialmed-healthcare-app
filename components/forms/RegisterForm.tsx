            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
                ...
                <div className="flex flex-col gap-6 xl:flex-row">
                    <CustomFormField
                        ...
                        placeholder="Please provide the name of your emergency contact"
                    />
                ...
                <div className="flex flex-col gap-6 xl:flex-row">
                    <CustomFormField
                        ...
                        placeholder="Please provide your insurance provider"
                    />
                ...
                <div className="flex flex-col gap-6 xl:flex-row">
                    <CustomFormField
                        ...
                        placeholder="Please provide any relevant family medical history"
                    />
                ...
                <CustomFormField
                    ...
                    fieldType={FormFieldType.CHECKBOX}
                    name="privacyConsent"
                    label="I hereby confirm that I have carefully reviewed and accepted Arialmed's privacy policy."
                />
